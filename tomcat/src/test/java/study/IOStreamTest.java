...
class IOStreamTest {
    ...
    class OutputStream_학습_테스트 {
        ...
        void OutputStream은_사용하고_나서_close_처리를_해준다() throws IOException {
            try (final OutputStream outputStream = mock(OutputStream.class)){ // 파일 열거나 자원 할당
                outputStream.close();
    ...
    class FilterStream_학습_테스트 {
         ...
         * InputStream 객체를 생성하고 필터 생성자에 전달하면 필터에 연결된다. -> 객체 생성 불가  -> bufferd input stream 의 자손 클라스
    ...
    class InputStreamReader_학습_테스트 {
        ...
        void BufferedReader를_사용하여_문자열을_읽어온다() throws IOException {
            ...
            final InputStream bufferedInputStream = new BufferedInputStream(inputStream);
            final InputStreamReader inputSreamReader = new InputStreamReader(bufferedInputStream);
            final BufferedReader bf = new BufferedReader(inputSreamReader);
            final StringBuilder actual = new StringBuilder();

            actual.append(bf.readLine());
            actual.append("\r\n");
            actual.append(bf.readLine());
            actual.append("\r\n");
            actual.append(bf.readLine());
